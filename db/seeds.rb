...
dmitriy = User.create(username: "khaitd", email: "dem@d.com", password: "demitry", gender: "male", weight: "200 lbs", height: "5'9", age: "26", goal: "maintenance")
...
7. When you are done, place the dumbbells back on your thighs and then on the floor. This is the safest manner to release the dumbbells.", link: "http://www.exrx.net/AnimatedEx/PectoralClavicular/DBInclineBenchPress.gif")
...
6. Continue alternating in this manner for the recommended amount of repetitions.", link: "http://www.exrx.net/AnimatedEx/Biceps/DBCurl.gif")
...
5. Repeat for the recommended amount of repetitions.", link: "http://www.exrx.net/AnimatedEx/Biceps/BBCurl.gif")
...
4. Repeat the movement for the prescribed amount of repetitions.", link: "http://www.exrx.net/AnimatedEx/RectusAbdominis/WTCrunch.gif")
...
4. Repeat for the recommended amount of repetitions.", link: "http://www.exrx.net/AnimatedEx/Obliques/DBSideBend.gif")
...
4. Repeat for the recommended amount of repetitions.", link: "http://www.exrx.net/AnimatedEx/BackGeneral/BBBentOverRow.gif")
...
4. Pause at the top of the motion, and then return to the starting position.", link: "http://www.exrx.net/AnimatedEx/BackGeneral/DBLyingRow.gif")
...
4. Lower the bar by bending at the hips and guiding it to the floor.", link: "http://www.exrx.net/AnimatedEx/ErectorSpinae/BBDeadlift.gif")
...
6. Repeat for the recommended amount of repetitions.", link: "http://www.exrx.net/AnimatedEx/ErectorSpinae/BWHyperExtensionHead.gif")
...
3. Extend through the elbow to straighten your arm, keeping your upper arm in place. Pause at the top of the motion, and return to the starting position.", link: "http://www.exrx.net/AnimatedEx/Triceps/BBLyingTricepsExtensionSC.gif")
...
6. Repeat for the recommended amount of repetitions and then perform the same movement with the other arm.", link: "http://www.exrx.net/AnimatedEx/Triceps/CBSeatedTricepsExtSupGrip.gif")
...
5. Repeat for the recommended amount of repetitions.", link: "http://www.exrx.net")
...
6. Repeat for the recommended amount of repetitions.", link: "http://www.exrx.net/AnimatedEx/DeltoidAnterior/DBArnoldPress.gif")
...
3. Continue down to full depth if you are able,and quickly reverse the motion until you return to the starting position. As you squat, keep your head and chest up and push your knees out.", link: "http://www.exrx.net")
...
6. Repeat for the recommended amount of repetitions.", link: "http://www.exrx.net/AnimatedEx/Quadriceps/BWSquat.gif")
...
4. Repeat the movement for the recommended amount of repetitions and then perform with the left leg.", link: "http://www.exrx.net/AnimatedEx/Quadriceps/DBLungeQuad.gif")
...
4. Repeat for the recommended amount of repetitions.", link: "http://www.exrx.net/AnimatedEx/TrapeziusUpper/BBShrug.gif")
...
5. Hold for a second at the starting position and repeat the movement for the prescribed amount of repetitions.", link: "http://www.exrx.net/AnimatedEx/PectoralSternal/CBStandingFly.gif")
